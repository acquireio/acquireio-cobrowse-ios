...
/**
 *  if your app main bundle has included AcquireIOConfig.plist
 *  then set useDefaultTheme YES to load default theme setting instead of your
 *  AcquireIOConfig.plist theme setting
 *
 *  if not set AcquireIOConfig.plist file in your app main bundle then always load theme setting
 *
