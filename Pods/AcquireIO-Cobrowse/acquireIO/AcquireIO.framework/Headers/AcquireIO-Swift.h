...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AcquireIO",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9AcquireIO13OnAckCallback")
...
SWIFT_CLASS("_TtC9AcquireIO7SSLCert")
...
SWIFT_CLASS("_TtC9AcquireIO16SocketAckEmitter")
...
SWIFT_CLASS("_TtC9AcquireIO14SocketAnyEvent")
...
///
/// \endcode
SWIFT_CLASS("_TtC9AcquireIO19SocketClientManager")
...
SWIFT_PROTOCOL("_TtP9AcquireIO16SocketEngineSpec_")
...
SWIFT_CLASS("_TtC9AcquireIO12SocketEngine")
...
@property (nonatomic, weak) id <SocketEngineClient> _Nullable client;
- (nonnull instancetype)initWithClient:(id <SocketEngineClient> _Nonnull)client url:(NSURL * _Nonnull)url options:(NSDictionary * _Nullable)options;
- (NSString * _Nonnull)isuWithQ:(NSString * _Nonnull)q SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC9AcquireIO14SocketIOClient")
...
SWIFT_CLASS("_TtC9AcquireIO9WebSocket")
